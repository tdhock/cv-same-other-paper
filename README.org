...
This repo contains code and data for reproducing [[https://onlinelibrary.wiley.com/doi/10.1002/sam.70055][Toby Dylan Hocking, Gabrielle Thibault, Cameron Scott Bodine, Paul Nelson Arellano, Alexander F. Shenkin, Olivia Jasmine Lindly, Same/Other/All K-Fold Cross-Validation for Estimating Similarity of Patterns in Data Subsets, Statistical Analysis and Data Mining 2026]]
...
- [[file:conv_images_10fold_test.csv]] source [[file:conv_images.R][R code]].
...
- Figure 8 five algos same versus other test error (top [[file:figure8top.png][PNG]]), convolutional test error (bottom [[file:figure8bottom.png][PNG]]), [[file:figure8.R][R code]].

*** Reproducing only NSCH autism results

- reproducing NSCH autism data [[file:NSCH_autism_reproduce.R][R code]], [[file:NSCH_autism_reproduce_proj_results.csv][CSV results computed on the cluster]].
- Figures [[file:NSCH_autism_reproduce_proj_results.R][R code]], [[file:NSCH_autism_reproduce_proj_results_figure4.png][Figure 4 PNG]], [[file:NSCH_autism_reproduce_proj_results_figure5.png][Figure 5 PNG]].

Bonus NSCH autism results that were not included in the paper!

- [[file:NSCH_autism_reproduce_timings.R][R code]] for comparing cluster computing packages [[file:NSCH_autism_reproduce_timings_rorqual.png][PNG cluster]], [[file:NSCH_autism_reproduce_timings.png][PNG+laptop]].
- [[file:NSCH_autism_reproduce_downsample.R][R code]] for NSCH downsample analysis (SOAKED), PNGs for [[file:NSCH_autism_reproduce_downsample_2019.png][2019]] and [[file:NSCH_autism_reproduce_downsample_2020.png][2020]].
- [[file:NSCH_autism_reproduce_compare_results.R][R code]] for comparing random seeds, no difference [[file:NSCH_autism_reproduce_compare_results.png][PNG]].
- [[file:NSCH_autism_reproduce_compare_results_all.R][R code]] for comparing random seeds (all), no difference [[file:NSCH_autism_reproduce_compare_results_all.png][PNG]].
...
And [[https://docs.google.com/presentation/d/1CsBYOMfbD5fiZoF_Eh6SjFOlifxzSEeKE2-sId2IISI][SOAKED slides]].
...
[[file:figure-SOAKED-seeds-data.R]] makes [[file:figure-SOAKED-seeds-data.csv]]

[[file:figure-SOAKED-seeds.R]] makes [[file:figure-SOAKED-seeds.png]]

** 30 Mar 2026

[[file:Phoenix_Baltimore_road_data.R]] reads
[[file:Phoenix_Baltimore_road_data.xlsx]] and
writes [[file:Phoenix_Baltimore_road_data.csv]] and

[[file:Phoenix_Baltimore_road_data.png]]

** 27 Feb 2026

[[file:data_Classif_batchmark_registry_times.R]] reads
[[file:data_Classif_batchmark_registry_times.csv]] and makes

[[file:data_Classif_batchmark_registry_times.png]]

** 24 Feb 2026

[[file:SOAKED_STL10_waveform.R]] computes downsample results [[file:SOAKED_STL10_waveform.csv]]

[[file:SOAKED_STL10_waveform_figure.R]] computes figures

[[file:SOAKED_STL10_waveform_figure_timing.png]]

[[file:SOAKED_STL10_waveform_figure_STL10_train.png]]

[[file:SOAKED_STL10_waveform_figure_waveform_train.png]]
